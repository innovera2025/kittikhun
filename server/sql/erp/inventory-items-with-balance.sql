...
--
-- ✅ ตรวจแล้วตรง 100% เมื่อ 22 ส.ค. 2569 (เทียบกับ tbl_CountDtl.MainQty บน db_TCL จริง
--    สองรอบ: CNT-2608-0001 93/93 · CNT-2608-0003 96/96 — ดู docs/erp-tcl-findings.md §6.6)
--    ควรรัน verify-balance.sql ซ้ำก่อน go-live เพราะข้อมูลเปลี่ยนได้
-- =============================================================================
