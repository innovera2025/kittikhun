...
- **โหมดสแกน (ส่วนขยาย §7 ข้อ 10 — design ต้นแบบไม่มี):** กรอบกล้องมี 2 หน้าตาตาม `scanMode` โดยไม่ย้ายชิ้นส่วนใดออกจากกรอบ (ป้ายสถานะอยู่ในกรอบ ลบกรอบทิ้งไม่ได้)
  - **HANDHELD** (ค่าเริ่มต้น): ตรึง 190px เสมอ ไม่ขยายเต็มจอ · ไม่มีเลเซอร์ · ไม่มีกรอบมุม · ไม่มีปุ่มกล้อง · กลางกรอบเป็น hero ไอคอนบาร์โค้ด 28px (`accentBright`) + **"ยิงบาร์โค้ดได้เลย"** + **"เล็งฉลากแล้วเหนี่ยวไก — ไม่ต้องแตะจอ"**
